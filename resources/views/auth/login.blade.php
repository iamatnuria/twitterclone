                    ...
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="email" type="email"
                                   class="form-input border border-gray-400 p-2 border-opacity-60 hover:border-gray-500 outline-none focus:border-opacity-100 rounded-md w-full @error('email') border-red-500 @enderror"
                                   name="email"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="password" type="password"
                                   class="form-input border border-gray-400 p-2 border-opacity-60 hover:border-gray-500 outline-none focus:border-opacity-100 rounded-md w-full @error('password') border-red-500 @enderror"
                                   name="password"
                                   required>
                        ...
                        <div class="flex items-center">
                            <label
                                ...
                                <span
                                    class="ml-2">{{ __('Remember Me') }}</span>
                            </label>
